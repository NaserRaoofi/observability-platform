...
output "loki_role_arn" {
  ...
  value       = var.create_loki_resources ? module.loki_role[0].arn : null
}

output "loki_role_name" {
  description = "Name of the Loki IAM role (if created)"
  value       = var.create_loki_resources ? module.loki_role[0].name : null
}
...
output "loki_service_account_annotation" {
  ...
  value = var.create_loki_resources ? {
    "eks.amazonaws.com/role-arn" = module.loki_role[0].arn
  } : null
}
...
output "grafana_role_arn" {
  ...
  value       = var.create_grafana_resources ? module.grafana_role[0].arn : null
}

output "grafana_role_name" {
  description = "Name of the Grafana IAM role (if created)"
  value       = var.create_grafana_resources ? module.grafana_role[0].name : null
}
...
output "grafana_service_account_annotation" {
  ...
  value = var.create_grafana_resources ? {
    "eks.amazonaws.com/role-arn" = module.grafana_role[0].arn
  } : null
}
...
output "tempo_role_arn" {
  ...
  value       = var.create_tempo_resources ? module.tempo_role[0].arn : null
}

output "tempo_role_name" {
  description = "Name of the Tempo IAM role (if created)"
  value       = var.create_tempo_resources ? module.tempo_role[0].name : null
}
...
output "tempo_service_account_annotation" {
  ...
  value = var.create_tempo_resources ? {
    "eks.amazonaws.com/role-arn" = module.tempo_role[0].arn
  } : null
}
...
output "roles_summary" {
  ...
  value = {
    mimir = {
      role_arn                   = module.mimir_role.arn
      role_name                  = module.mimir_role.name
    ...
    loki = var.create_loki_resources ? {
      role_arn                   = module.loki_role[0].arn
      role_name                  = module.loki_role[0].name
      kubernetes_namespace       = var.monitoring_namespace
      kubernetes_service_account = "loki"
      permissions                = ["DynamoDB:ReadWrite", "S3:ReadWrite", "CloudWatch:Logs"]
    } : null
    grafana = var.create_grafana_resources ? {
      role_arn                   = module.grafana_role[0].arn
      role_name                  = module.grafana_role[0].name
      kubernetes_namespace       = var.monitoring_namespace
      kubernetes_service_account = "grafana"
      permissions                = ["CloudWatch:ReadOnly", "Prometheus:ReadOnly"]
    } : null
    tempo = var.create_tempo_resources ? {
      role_arn                   = module.tempo_role[0].arn
      role_name                  = module.tempo_role[0].name
      kubernetes_namespace       = var.monitoring_namespace
